        ...
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            if (!context.Products.Any())
            {
                context.Products.AddRange(
                    ...
                    , new Product { Name = "Thinkin Cap", Description = "Improve brain efficiency by 75%", Category = "Chess", Price = 16 }
                    , new Product { Name = "Human Chess Board", Description = "A fun game for all the family", Category = "Chess", Price = 75 }
